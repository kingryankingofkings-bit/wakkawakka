...
const PROFILE_THEMES = [
  { id: "none", label: "Default", bg: "bg-background border-border" },
  {
    id: "ocean",
    label: "Ocean Depth",
    bg: "bg-gradient-to-br from-blue-900/40 to-teal-900/40 border-blue-500/20",
  },
  {
    id: "sunset",
    label: "Warm Sunset",
    bg: "bg-gradient-to-br from-orange-500/30 to-pink-500/30 border-orange-500/20",
  },
  {
    id: "aurora",
    label: "Neon Aurora",
    bg: "bg-gradient-to-br from-purple-600/30 via-pink-500/30 to-blue-500/30 border-purple-500/20",
  },
  {
    id: "midnight",
    label: "Midnight Glass",
    bg: "bg-black/60 backdrop-blur-2xl border-white/10",
  },
];
        ...
        >
          ...
          <div className="w-full sm:w-64 bg-muted/30 border-r border-border shrink-0 flex flex-col">
            ...
            <div className="p-4 sm:hidden">
              <button
                onClick={onClose}
                className="w-full py-2 bg-muted rounded-xl text-sm font-semibold"
              >
                Close
              </button>
            </div>
          ...
          <div className="flex-1 flex flex-col relative overflow-hidden bg-background">
                    ...
                    >
                      <div className="mb-8">
                        ...
                        <p className="text-sm text-muted-foreground">
                          This is how others will see you on Wakka.
                        </p>
                      </div>
                      ...
                      <div className="mb-10 relative">
                        <div
                          className="h-40 bg-muted rounded-2xl overflow-hidden relative cursor-pointer group border border-border"
                        ...
                        <div className="absolute -bottom-8 left-6">
                          <div
                            className="w-24 h-24 rounded-full ring-4 ring-background bg-card overflow-hidden cursor-pointer group relative"
                      ...
                      <div className="space-y-5">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                          <div>
                            ...
                            <input
                              ...
                              className="w-full px-4 py-2.5 bg-muted/40 border border-border rounded-xl focus:ring-2 focus:ring-primary outline-none transition-all"
                            />
                            {errors.displayName && (
                        ...
                        <div>
                          ...
                          <textarea
                            {...register("bio")}
                            rows={3}
                            className="w-full px-4 py-3 bg-muted/40 border border-border rounded-xl focus:ring-2 focus:ring-primary outline-none transition-all resize-none"
                          />
                        </div>
                  ...
                  {activeSection === "theme" && (
                    ...
                    >
                      <div className="mb-8">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Make your profile truly yours with custom colors and
                          tab arrangements.
                        </p>
                      </div>
                      ...
                      <div className="space-y-8">
                        ...
                        <div>
                          <label className="text-sm font-bold text-foreground mb-3 flex items-center gap-2">
                            <Palette className="w-4 h-4 text-primary" /> Profile
                            Background Theme
                          </label>
                          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                            {PROFILE_THEMES.map((theme) => (
                              <div
                                key={theme.id}
                                onClick={() =>
                                  setValue("profileTheme", theme.id)
                                }
                                className={cn(
                              ...
                              >
                                <span className="text-xs font-bold text-foreground/90 bg-background/50 backdrop-blur-sm px-2 py-0.5 rounded-lg">
                                  {theme.label}
                                </span>
                                {watchedTheme === theme.id && (
                        ...
                        <div>
                          <label className="text-sm font-bold text-foreground mb-3 flex items-center gap-2">
                            <Palette className="w-4 h-4 text-primary" /> UI
                            Accent Color
                          </label>
                                  ...
                                  {ACCENT_COLORS.map((c) => (
                                    <button
                                      ...
                                      className={cn(
                                        ...
                                        field.value === c.name
                                          ? "scale-110 ring-4 ring-background shadow-lg"
                        ...
                        <div>
                          ...
                          <div className="bg-muted/20 border border-border rounded-2xl overflow-hidden divide-y divide-border">
                            {watchedTabs.map((tab, idx) => (
                              <div
                                key={tab}
                                className="flex items-center justify-between p-3 bg-card hover:bg-muted/50 transition-colors"
                              >
                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => moveTab(idx, 1)}
                                    disabled={idx === watchedTabs.length - 1}
                                    className="p-1.5 rounded-lg hover:bg-muted disabled:opacity-30"
                                  >
                  ...
                  {activeSection === "widgets" && (
                    ...
                    >
                      <div className="mb-8">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Add interactive elements and control visibility on
                          your profile.
                        </p>
                      </div>
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 border border-purple-500/20 p-5 rounded-2xl relative overflow-hidden">
                          ...
                          <p className="text-xs text-muted-foreground mb-4 max-w-sm">
                            Search and select a soundtrack for your profile
                            header.
                          </p>
                          ...
                          <label className="flex items-center justify-between cursor-pointer p-3 bg-background/50 rounded-xl mb-4 border border-border/40 relative z-10">
                            <div>
                              ...
                              <span className="text-[10px] text-muted-foreground">
                                Toggle whether the soundtrack is visible and
                                playable on your profile.
                              </span>
                            </div>
                            <input
                              type="checkbox"
                              {...register("profileSoundtrackVisible")}
                          ...
                          {watchedSoundtrack ? (
                            <div className="mb-4 p-3 bg-background border border-purple-500/30 rounded-xl flex items-center justify-between relative z-10">
                              <div>
                                ...
                                <p className="text-[11px] text-muted-foreground">
                                  {watchedSoundtrack.split("|")[0].trim()}
                                </p>
                              </div>
                              <button
                                type="button"
                                onClick={() =>
                                  setValue("profileSoundtrack", "")
                                }
                            ...
                            <div className="mb-4 text-xs text-muted-foreground relative z-10">
                              No soundtrack selected. Search below to add one!
                            </div>
                          )}
                        ...
                        <div className="border border-border p-5 rounded-2xl space-y-4">
                          <label className="text-sm font-bold text-foreground flex items-center gap-2">
                            <EyeOff className="w-4 h-4 text-primary" /> Profile
                            Data Visibility
                          </label>
                          ...
                          <label className="flex items-center justify-between cursor-pointer p-3 bg-muted/30 rounded-xl hover:bg-muted/50 transition-colors">
                            <div>
                              ...
                              <span className="text-xs text-muted-foreground">
                                Your follower count will be hidden from everyone
                                except you.
                              </span>
                            </div>
                            <input
                              type="checkbox"
                              {...register("hideFollowerCount")}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 bg-background/80 backdrop-blur-xl border-t border-border flex justify-end gap-3 z-20">
              <button
                onClick={onClose}
                className="px-6 py-2.5 text-sm font-semibold rounded-xl hover:bg-muted transition-colors"
              >
                Cancel
              </button>
              <button
