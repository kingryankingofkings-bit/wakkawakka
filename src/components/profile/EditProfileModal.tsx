...
export function EditProfileModal({ activeProfile: user, onClose }: EditProfileModalProps) {
  ...
  async function generateAiCss() {
    if (!aiPrompt.trim()) return;
    setIsGeneratingCss(true);
    // Mock AI delay
    await new Promise((r) => setTimeout(r, 1500));
    const mockCss = `/* Generated by AI for: ${aiPrompt} */\nbody {\n  background-image: url('https://source.unsplash.com/random/1600x900/?${encodeURIComponent(aiPrompt)}');\n  background-size: cover;\n}\n.profile-card {\n  backdrop-filter: blur(10px);\n  background: rgba(0,0,0,0.5);\n}`;
    setValue("customCss", mockCss, { shouldDirty: true });
    setAiPrompt("");
    setIsGeneratingCss(false);
    toast.success("AI generated your MySpace-style CSS!");
  }
                  ...
                  {activeSection === "theme" && (
                    ...
                    >
                      ...
                      <div className="space-y-8">
                        ...
                        {/* Custom CSS AI Generator */}
                        <div>
                          <label className="text-sm font-bold text-foreground mb-3 flex items-center gap-2">
                            <Sparkles className="w-4 h-4 text-purple-500" /> MySpace-Style Custom CSS
                          </label>
                          <div className="bg-muted/20 border border-border p-4 rounded-2xl space-y-4">
                            <p className="text-xs text-muted-foreground">
                              Describe how you want your profile to look, and our Basic Coding AI will write the CSS for you.
                            </p>
                            <div className="flex gap-2">
                              <input
                                type="text"
                                placeholder="e.g. Matrix green raining code background with glowing neon borders"
                                value={aiPrompt}
                                onChange={(e) => setAiPrompt(e.target.value)}
                                className="flex-1 px-4 py-2 bg-background border border-border rounded-xl text-sm focus:ring-2 focus:ring-primary outline-none"
                              />
                              <button
                                type="button"
                                onClick={generateAiCss}
                                disabled={isGeneratingCss || !aiPrompt.trim()}
                                className="px-4 py-2 bg-primary text-primary-foreground font-bold text-sm rounded-xl hover:bg-primary/90 transition-colors disabled:opacity-50 flex items-center gap-2"
                              >
                                {isGeneratingCss ? "Generating..." : "Generate AI CSS"}
                              </button>
                            </div>
                            <div>
                              <textarea
                                {...register("customCss")}
                                rows={4}
                                placeholder="/* Or paste your own CSS here */"
                                className="w-full px-4 py-3 bg-black/50 border border-border rounded-xl text-xs font-mono text-green-400 focus:ring-2 focus:ring-primary outline-none resize-y"
                              />
                            </div>
                          </div>
                        </div>
                    ...
                    >
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 border border-purple-500/20 p-5 rounded-2xl relative overflow-hidden">
                          ...
                          {/* Search Widget / MP3 Upload */}
                          <div className="space-y-4 relative z-10">
                            <div className="space-y-2">
                              <label className="text-xs font-semibold text-foreground">Direct MP3 URL</label>
                              <div className="flex gap-2">
                                <input
                                  type="url"
                                  placeholder="https://example.com/song.mp3"
                                  {...register("profileSoundtrack")}
                            ...
                            <div className="space-y-2">
                              <label className="text-xs font-semibold text-foreground">Search Spotify</label>
                              <div className="flex gap-2">
                                <input
                                  type="text"
