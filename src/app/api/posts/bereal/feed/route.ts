...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // 1. Check if the querying user has created a BeReal post in the last 24 hours
    ...
    // 5. Get BeReal posts from friends created in the last 24 hours
    ...
    return NextResponse.json(
      { error: "Failed to fetch BeReal feed", detail: String(err) },
      { status: 500 },
    );
  }
}
