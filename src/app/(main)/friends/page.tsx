      ...
      <div className="p-4 space-y-3">
        ...
        {!loading &&
          ...
          (friends.length === 0 ? (
            <EmptyState
              icon={Users}
              text="No friends yet. Check Suggestions to connect with people."
            />
          ) : (
            friends.map((f) => (
              <PersonRow
        ...
        {!loading &&
          ...
          (suggestions.length === 0 ? (
            <EmptyState
              icon={Sparkles}
              text="No suggestions right now. Come back later."
            />
          ) : (
            suggestions.map((s) => (
              <PersonRow
    ...
    <Card padding="sm" className="flex items-center gap-3">
      ...
      <div className="flex-1 min-w-0">
        ...
        >
          ...
          {user.isVerified && (
            <VerificationBadge
              tier={(user.verificationTier as never) || "BLUE"}
              size="sm"
            />
          )}
        </Link>
